...
当前选定的飞书或钉钉连接器。项目同时提供飞书文章的多平台稿件导出能力，帮助将已有内容
适配为微信公众号、知乎或抖音的人工发布稿。
...
| 入口               | 输入                                      | 处理结果                                       | 适用场景                       |
| ------------------ | ----------------------------------------- | ---------------------------------------------- | ------------------------------ |
| 视频学习笔记       | B站或抖音视频链接                         | 转录原文、结构化学习笔记、知识框架图、连接器文档 | 公开课程、教程、访谈、知识视频 |
...
| lark-cli 且已登录          | 飞书文档、任务与授权         | 飞书连接器、文章导出   |
...
平台视频还需要 `yt-dlp`；文档笔记和文章导出分别依赖当前连接器的授权状态。
...
```text
client/                         React 19 前端
  src/pages/                    各资料入口、参数配置、历史、手册与文章导出页面
server/                         NestJS 后端
