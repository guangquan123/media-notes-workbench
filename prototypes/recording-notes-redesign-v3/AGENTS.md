...
- 2026-09-01: 用户要求准备态不再展示“开始一段新录音”引导标题、说明文案和装饰麦克风图标；准备页直接从步骤轨道进入录音设置与麦克风检测，以减少首屏空白。
- 2026-09-01: 用户要求隐藏页面底部隐私提示；步骤轨道进一步采用完成态绿色、当前态蓝色分组底色，保持原高度并提升状态辨识度。
- 2026-09-01: 用户确认准备态操作区旁的隐私说明也属于多余底部文案；已移除两处隐私提示，并让开始录音操作区独占底部行。
- 2026-09-01: 用户认为三步进度条视觉过重；v7 改为白色轻量容器、圆形状态节点和 Chevron 箭头连接，仅保留当前/完成颜色强调。
